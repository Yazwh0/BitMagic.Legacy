...
public class EOR
{
    ...
    public async Task Imm()
    {
        ...
        // compilation
        Assert.AreEqual(0x49, emulator.Memory[0x810]);
    ...
    public async Task Imm_CarryPreserve()
    {
        ...
        // emulation
        emulator.AssertState(0b00000001, 0x00, 0x00, 0x813, 2);
    ...
    public async Task Abs()
    {
        ...
        // compilation
        Assert.AreEqual(0x4d, emulator.Memory[0x810]);
    ...
    public async Task AbsX()
    {
        ...
        // compilation
        Assert.AreEqual(0x5d, emulator.Memory[0x810]);
        Assert.AreEqual(0x00, emulator.Memory[0x811]);
        Assert.AreEqual(0x12, emulator.Memory[0x812]);

        // emulation
        emulator.AssertState(0x01, 0x34, 0x00, 0x814, 4);
        emulator.AssertFlags(false, false, false, false);
    }
    ...
    public async Task AbsX_PagePenatly()
    {
        ...
        // emulation
        emulator.AssertState(0x01, 0x70, 0x00, 0x814, 5);
        emulator.AssertFlags(false, false, false, false);
    }
    ...
    public async Task AbsY()
    {
        ...
        // compilation
        Assert.AreEqual(0x59, emulator.Memory[0x810]);
        Assert.AreEqual(0x00, emulator.Memory[0x811]);
        Assert.AreEqual(0x12, emulator.Memory[0x812]);

        // emulation
        emulator.AssertState(0x01, 0x00, 0x34, 0x814, 4);
        emulator.AssertFlags(false, false, false, false);
    }
    ...
    public async Task AbsY_PagePenatly()
    {
        ...
        // emulation
        emulator.AssertState(0x01, 0x00, 0x70, 0x814, 5);
        emulator.AssertFlags(false, false, false, false);
    }
    ...
    public async Task Zp()
    {
        ...
        // compilation
        Assert.AreEqual(0x45, emulator.Memory[0x810]);
    ...
    public async Task ZpX()
    {
        ...
        // compilation
        Assert.AreEqual(0x55, emulator.Memory[0x810]);
    ...
    public async Task IndZp()
    {
        ...
        // compilation
        Assert.AreEqual(0x52, emulator.Memory[0x810]);
        Assert.AreEqual(0x12, emulator.Memory[0x811]);
    ...
    public async Task IndX()
    {
        ...
        // compilation
        Assert.AreEqual(0x41, emulator.Memory[0x810]);
        Assert.AreEqual(0x10, emulator.Memory[0x811]);
    ...
    public async Task IndY()
    {
        ...
        // compilation
        Assert.AreEqual(0x51, emulator.Memory[0x810]);
        Assert.AreEqual(0x10, emulator.Memory[0x811]);

        // emulation
        emulator.AssertState(0x01, 0x00, 0x34, 0x813, 5);
        emulator.AssertFlags(false, false, false, false);
    }
    ...
    public async Task IndY_PagePenatly()
    {
        ...
        // emulation
        emulator.AssertState(0x01, 0x00, 0x70, 0x813, 6);
        emulator.AssertFlags(false, false, false, false);
    }
}