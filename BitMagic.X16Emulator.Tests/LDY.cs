...
public class LDY
{
    ...
    public async Task Immediate()
    {
        ...
        // emulation
        emulator.AssertState(0x00, 0x00, 0x44, 0x813);
    ...
    public async Task Immediate_NegativeFlag()
    {
        ...
        // emulation
        emulator.AssertState(0x00, 0x00, 0xff, 0x813);
    ...
    public async Task ZeroPageX()
    {
        ...
        // emulation
        emulator.AssertState(0x00, 0x02, 0x44, 0x813);
        emulator.AssertFlags(false, false, false, false);
    }
    ...
    public async Task ZeroPageX_Wrap()
    {
        ...
        // emulation
        emulator.AssertState(0x00, 0x72, 0x44, 0x813);
        emulator.AssertFlags(false, false, false, false);
    }
    ...
    public async Task Absolute()
    {
        ...
        // emulation
        emulator.AssertState(0x00, 0x00, 0x44, 0x814);
        emulator.AssertFlags(false, false, false, false);
    }
    ...
    public async Task AbsoluteX()
    {
        ...
        // emulation
        emulator.AssertState(0x00, 0x02, 0x44, 0x814);
        emulator.AssertFlags(false, false, false, false);
    }
}
