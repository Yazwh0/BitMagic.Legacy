...
{
    public class CommanderX16R39 : IMachineEmulator
    {
        ...
        private CommanderX16R39Defaults _defaultVariables = new();
        ...
        public void Build()
        {
            ...
            Memory = new MemoryMap(0, 0x10000, new IMemoryBlock[] {
                ...
                (0x00, bankedRam.Switch),
                (0x01, bankedRom.Switch)
            });
