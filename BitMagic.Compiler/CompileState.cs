...
namespace BitMagic.Compiler
{
    internal class CompileState
    {
        ...
        public CompileState(Variables globals, string defaultFileName)
        {
            ...
            var segment = new Segment(Globals, true, 0x801, "_DefaultSegment", defaultFileName); // use '.' so this cant be generated by the user
            var scope = ScopeFactory.GetScope($"_DefaultScope");
