...
BitMagic.AsmTemplate.Template.WriteLiteral($@".proc inflate_to_ram");
BitMagic.AsmTemplate.Template.WriteLiteral($@".const inputPointer                    = {Source}");
BitMagic.AsmTemplate.Template.WriteLiteral($@".const outputPointer                   = {Source+2}");
...
BitMagic.AsmTemplate.Template.WriteLiteral($@".const inflateCodes_sourcePointer      = {Source+6}  ; 2 bytes");

BitMagic.AsmTemplate.Template.WriteLiteral($@".const inflateDynamic_symbol           = {Source+6}  ;6 1 byte");
BitMagic.AsmTemplate.Template.WriteLiteral($@".const inflateDynamic_lastLength       = {Source+7}  ;7 1 byte");
BitMagic.AsmTemplate.Template.WriteLiteral($@".const inflateDynamic_tempCodes        = {Source+7}  ;7 1 byte");
...
BitMagic.AsmTemplate.Template.WriteLiteral($@";sne:ldx	#LENGTH_SYMBOLS");
...
BitMagic.AsmTemplate.Template.WriteLiteral($@"stp");
BitMagic.AsmTemplate.Template.WriteLiteral($@"jsr	storeByte");
...
BitMagic.AsmTemplate.Template.WriteLiteral($@"sta	inflateCodes_lengthMinus2 ; -2 as the length is always greater than 3.");
...
BitMagic.AsmTemplate.Template.WriteLiteral($@"stp ; at this point a is the low number of bytes to look back");
BitMagic.AsmTemplate.Template.WriteLiteral($@"eor	#$ff");
BitMagic.AsmTemplate.Template.WriteLiteral($@"sta	inflateCodes_sourcePointer");
...
BitMagic.AsmTemplate.Template.WriteLiteral($@"stp ; at this point a is the hig number of bytes to look back");
BitMagic.AsmTemplate.Template.WriteLiteral($@"eor	#$ff");
BitMagic.AsmTemplate.Template.WriteLiteral($@";	clc");
BitMagic.AsmTemplate.Template.WriteLiteral($@";   invert and add output pointer to get a address relative to the output pointer?");
BitMagic.AsmTemplate.Template.WriteLiteral($@"adc	outputPointer+1");
BitMagic.AsmTemplate.Template.WriteLiteral($@"sta	inflateCodes_sourcePointer+1");
...
BitMagic.AsmTemplate.Template.WriteLiteral($@"ldy	outputPointer");
BitMagic.AsmTemplate.Template.WriteLiteral($@"lda	(inflateCodes_sourcePointer),y");
BitMagic.AsmTemplate.Template.WriteLiteral($@"ldy	#0");

BitMagic.AsmTemplate.Template.WriteLiteral($@"; Write a byte");
BitMagic.AsmTemplate.Template.WriteLiteral($@".storeByte:");
BitMagic.AsmTemplate.Template.WriteLiteral($@";	ldy	#0");
BitMagic.AsmTemplate.Template.WriteLiteral($@"sta	(outputPointer),y");
BitMagic.AsmTemplate.Template.WriteLiteral($@"inc	outputPointer");
BitMagic.AsmTemplate.Template.WriteLiteral($@"bne	storeByte_return");
BitMagic.AsmTemplate.Template.WriteLiteral($@"inc	outputPointer+1");
BitMagic.AsmTemplate.Template.WriteLiteral($@"inc	inflateCodes_sourcePointer+1");
