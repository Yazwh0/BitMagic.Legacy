...
namespace BitMagic.AsmTemplateEngine
{
    public static class CsasmEngine
    {
        public static ITemplateEngine CreateEngine() => TemplateEngineBuilder
                ...
                // 65c02
                .WithUnderlying(new Regex(@"^\s*(?<line>((?i)(bra|phx|phy|plx|ply|stz|trb|tsb|bbr0|bbr1|bbr2|bbr3|bbr4|bbr5|bbr6|bbr7|bbs0|bbs1|bbs2|bbs3|bbs4|bbs5|bbs6|bbs7|rmb0|rmb1|rmb2|rmb3|rmb4|rmb5|rmb6|rmb7|smb0|smb1|smb2|smb3|smb4|smb5|smb6|smb7|wai)(\s+.*|)))$", RegexOptions.Compiled))
