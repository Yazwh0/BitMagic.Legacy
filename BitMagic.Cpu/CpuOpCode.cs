...
namespace BitMagic.Cpu
{
    public abstract class CpuOpCode : ICpuOpCode
    {
        ...
        public abstract int Process(Func<(byte value, int timing, ushort pcStep)> GetValueAtPC, Func<(ushort address, int timing, ushort pcStep)> GetAddressAtPc, IMemory memory, I6502 cpu);
